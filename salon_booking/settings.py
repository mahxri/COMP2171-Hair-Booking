...
# Load environment variables from .env (Improvement E)
...
INSTALLED_APPS = [
    ...
    'bookings',
    'django_apscheduler',  # Improvement A — for daily reminder emails
]
...
# ── EMAIL CONFIGURATION (Feature 8.0 + Improvement E) ─────────────────────────
...
# ── APSCHEDULER SETTINGS (Improvement A) ──────────────────────────────────────
